...
.main-section {
    ...
    .main-section form {
        ...
        padding: 30px; /* Tambahkan padding di sekitar konten form */
        border-radius: 15px;
        background-color: #f8f9fa;
        box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.15);
    }
    .form-group {
        margin-bottom: 20px; /* Memberikan jarak antar field form */
    }
    .btn-primary {
...
<div class="container main-section">
    <h2 class="text-center">Masukkan Kontak</h2>
    <div class="form-container">
        <!-- Notifikasi yang muncul ketika pesan berhasil dikirim -->
        @if(session('success'))
            <div id="successAlert" class="alert alert-success alert-custom animate__animated animate__fadeInRight" role="alert">
                {{ session('success') }}
            </div>
        @endif
